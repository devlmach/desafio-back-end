...
namespace DesafioBackEnd.API.Application.Service
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public UsuarioService(IMapper mapper, IMediator mediator, UserManager<ApplicationUser> userManager)
        {
            _mapper = mapper;
            _mediator = mediator;
        ...
        {
            var productDeleteCommand = new UsuarioDeleteCommand(id!.Value) ?? throw new NotFoundException($"Entity could not be found");
        ...
        {
            var usuario = new GetUsuarioByIdQuery(id!.Value) ?? throw new NotFoundException($"Entity could not be found");
